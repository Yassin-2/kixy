      ...
      <section className="py-12 ">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {services.map((service, index) => (
            <div key={index} className="p-6 text-center border border-gray-400 backdrop-blur-2xl  bg-gray-500 rounded-lg  shadow-sm">
              <div className="text-4xl mb-4">{service.icon}</div>
              <h3 className="text-xl text-gray-200 font-bold mb-2">{service.title}</h3>
